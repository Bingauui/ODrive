...
struct ODrive3ConfigTypeInfo : TypeInfo {
    ...
    introspectable_storage_t get_child(introspectable_storage_t obj, size_t idx) const override {
        ...
        switch (idx) {
            ...
            case 38: *(decltype(ODrive3Intf::ConfigIntf::get_gpio1_pwm_mapping(std::declval<T*>()))*)(&res) = ODrive3Intf::ConfigIntf::get_gpio1_pwm_mapping(ptr); break;
            case 39: *(decltype(ODrive3Intf::ConfigIntf::get_gpio2_pwm_mapping(std::declval<T*>()))*)(&res) = ODrive3Intf::ConfigIntf::get_gpio2_pwm_mapping(ptr); break;
            case 40: *(decltype(ODrive3Intf::ConfigIntf::get_gpio3_pwm_mapping(std::declval<T*>()))*)(&res) = ODrive3Intf::ConfigIntf::get_gpio3_pwm_mapping(ptr); break;
            case 41: *(decltype(ODrive3Intf::ConfigIntf::get_gpio4_pwm_mapping(std::declval<T*>()))*)(&res) = ODrive3Intf::ConfigIntf::get_gpio4_pwm_mapping(ptr); break;
        }
        return res;
    }
};
